      ...
      <div className="flex-1 flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-sm">
          <div className="bg-card border rounded-2xl p-6 shadow-sm flex flex-col items-center text-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold font-serif">Password updated!</h2>
    ...
    <div className="flex-1 flex items-center justify-center py-16 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold font-serif mb-2">Set new password</h1>
        ...
        <div className="bg-card border rounded-2xl p-6 shadow-sm">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11" disabled={resetPassword.isPending || !token}>
              {resetPassword.isPending && <Loader2 className="mr-2 w-4 h-4 animate-spin" />}
              Update Password
            </Button>
          </form>
        </div>
